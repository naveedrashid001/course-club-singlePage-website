...
const MainPage = () => {
    ...
    <div>
      <div  className="row pt-2 py-1 pl-2 mt-4">
        ...
        <div className='col-sm-4' >
            ...
            <img src="https://courseclub.me/wp-content/uploads/2023/12/516320-357x210.png" alt="pic-1" height={"230px"}/>
            </div>

            <div className=' card mt-3 p-2'  >
            <img src="https://courseclub.me/wp-content/uploads/2023/11/3215685-357x210.png" alt="pic-1" height={"230px"}/>
        </div>

        <div className=' card mt-3 p-2'  >
            <img src="https://courseclub.me/wp-content/uploads/2023/11/9784646123-357x210.png" alt="pic-1" height={"230px"}/>
        </div>

        <div className=' card mt-3 p-2'  >
            <img src="https://courseclub.me/wp-content/uploads/2023/11/436576-357x210.png" alt="pic-1" height={"230px"}/>
        </div>
        </div>
        {/* 2nd  */}
        <div className=' col-sm-4  p-2'>
            <div className='card  p-2'>
            <img src="https://courseclub.me/wp-content/uploads/2023/12/45656263-357x210.jpg" alt="pic-1" height={"230px"}/>
            </div>
            <div className=' card mt-3 p-2'  >
            <img src="https://courseclub.me/wp-content/uploads/2023/11/32132312-357x210.jpeg" alt="pic-1" height={"230px"}/> 
        </div>

        <div className=' card mt-3 p-2'  >
            <img src="https://courseclub.me/wp-content/uploads/2023/11/23445344-357x210.jpg" alt="pic-1" height={"230px"}/>
        </div>

        <div className=' card mt-3 p-2'  >
            <img src="https://courseclub.me/wp-content/uploads/2023/11/653120-357x210.jpg" alt="pic-1" height={"230px"}/>
        </div>
        ...
        <div className='col-sm-4'>
            ...
            <p>Enter your email address to get all of our premium Lynda, Pluralsight, Laracasts and many more courses direct into your email box :-)</p>
  ...
  <button  style={{border:"none"}}>Ai</button> </a>
